...
- Changed the log level environment variable to only accept strings ("DEBUG", "INFO", "ERROR"), see [the wiki](https://github.com/mutdroco/mpquic_arm_raspi/wiki/Logging) for more details.
